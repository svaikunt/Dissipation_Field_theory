...
Overall, the results of this Section illustrate how dissipation affects the transport and structural properties of driven liquids, measured in terms of diffusion coefficient and density fluctuations. This immediately suggests that internal transport and emerging structure can potentially be tuned externally by monitoring the nonequilibrium forces which power the dissipation. \textcolor{blue}{Motivated by these results, we now use the framework of large deviation theory to monitor fluctuations in 
