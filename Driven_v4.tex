...
%Let us discuss the consequence of different particle sizes between the bath and tracer particles on these relations \eqref{eq:large}. Such a setting can be made by modifying the interaction potential $v$ in Eq.~\eqref{eq:dyn}.
