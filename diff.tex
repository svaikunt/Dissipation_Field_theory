...
%DIF DEL ActiveDriven_v_rev_4.tex   Sun May 19 22:21:06 2019
%DIF ADD v_rev_3.tex                Sun May 19 22:21:06 2019
...
\begin{equation}\label{eq:balance}
	\begin{aligned}
		&\DIFaddbegin \DIFadd{\gamma}\DIFaddend \dot w = \DIFdelbegin \DIFdel{\frac{2\rho_0}{\gamma} }\DIFdelend \DIFaddbegin \DIFadd{2}\bar\DIFadd{\rho_0 }\DIFaddend \int g({\bf r}) \big[(\nabla v({\bf r}))^2 - T \nabla^2 v({\bf r})\big] \dd{\bf r} ,
		\\
		&\, + \DIFdelbegin \DIFdel{\frac{\rho_0^2}{\gamma} }\DIFdelend \DIFaddbegin \bar\DIFadd{\rho_0^2 }\DIFaddend \iint\big[ g_{3a}({\bf r}, {\bf r}') + g_{3b}({\bf r}, {\bf r}')\big]  \big[\nabla v({\bf r})\big] \cdot \big[\nabla v({\bf r}')\big] \dd{\bf r} \dd{\bf r}' ,
	\end{aligned}
\end{equation}
where \DIFaddbegin \DIFadd{$\bar\rho_0 = \rho_0(1-p)$ is defined in terms of the total density $\rho_0$ and the fraction of driven tracers $p$, and
...
\DIFadd{This empirical relation, in combination with }\DIFaddend ~\eqref{eq:balance}\DIFdelbegin \DIFdel{and~}%DIFDELCMD < \eqref{eq:emp}%%%
\DIFdel{, we deduce the following integral relation between density correlations }\DIFdelend \DIFaddbegin \DIFadd{, suggests the following connection between two and three body correlations in our non-equilibrium system
}\DIFaddend \begin{equation}\DIFdelbegin %DIFDELCMD < \label{eq:emp_b}
%DIFDELCMD < 	%%%
\DIFdelend 
    \DIFaddbegin \label{eq:empiricalbalance1}
    \DIFaddend \begin{aligned}
    &\DIFdelbegin \DIFdel{-}\DIFdelend \DIFaddbegin \DIFadd{\rho^2 }\DIFaddend \int \DIFdelbegin %DIFDELCMD < \big[ %%%
\DIFdel{g(}\DIFdelend \DIFaddbegin \DIFadd{\int\ d}\DIFaddend {\bf r} \DIFdelbegin \DIFdel{) + }\DIFdelend \DIFaddbegin \DIFadd{d}{\bf \DIFadd{r}}\DIFadd{^\prime }\DIFaddend g\DIFdelbegin \DIFdel{_{\rm eq}}\DIFdelend \DIFaddbegin \DIFadd{_3}\DIFaddend ({\bf r}\DIFaddbegin \DIFadd{,}{\bf \DIFadd{r}}\DIFadd{^\prime}\DIFaddend )\DIFdelbegin %DIFDELCMD < \big] \big[%%%
\DIFdel{(}\DIFdelend \DIFaddbegin \left[\DIFaddend \nabla \DIFdelbegin \DIFdel{v}\DIFdelend \DIFaddbegin \DIFadd{u}\DIFaddend ({\bf r})\DIFdelbegin \DIFdel{)^2 - T }\DIFdelend \DIFaddbegin \DIFadd{\cdot }\DIFaddend \nabla \DIFdelbegin \DIFdel{^2 v}\DIFdelend \DIFaddbegin \DIFadd{u}\DIFaddend ({\bf r}\DIFaddbegin \DIFadd{^\prime}\DIFaddend )\DIFdelbegin %DIFDELCMD < \big] %%%
\DIFdel{\dd{\bf r}
		}\DIFdelend \DIFaddbegin \right]\DIFaddend \\
    &\DIFdelbegin \DIFdel{\simeq }\DIFdelend \DIFaddbegin \quad \DIFadd{=-}\DIFaddend \rho_0 \DIFdelbegin %DIFDELCMD < \iint\big[ %%%
\DIFdel{g_{3a}(}\DIFdelend \DIFaddbegin \DIFadd{\int d}\DIFaddend {\bf r}\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{\frac{1}{2}}\left[\DIFadd{g(}\DIFaddend {\bf r}\DIFdelbegin \DIFdel{') }\DIFdelend +g\DIFdelbegin \DIFdel{_{3b}}\DIFdelend \DIFaddbegin \DIFadd{_{\rm eq}}\DIFaddend ({\bf r}\DIFdelbegin \DIFdel{, }%DIFDELCMD < {\bf %%%
\DIFdel{r}%DIFDELCMD < }%%%
\DIFdel{'}\DIFdelend )\DIFdelbegin %DIFDELCMD < \big]  \big[%%%
\DIFdelend \DIFaddbegin \right]\left[\DIFaddend \nabla \DIFdelbegin \DIFdel{v}\DIFdelend \DIFaddbegin \DIFadd{u}\DIFaddend ({\bf r})\DIFdelbegin %DIFDELCMD < \big] %%%
\DIFdel{\cdot }%DIFDELCMD < \big[%%%
\DIFdelend \DIFaddbegin \DIFadd{^2-T}\DIFaddend \nabla\DIFdelbegin \DIFdel{v}\DIFdelend \DIFaddbegin \DIFadd{^2 u}\DIFaddend ({\bf r}\DIFdelbegin \DIFdel{'}\DIFdelend )\DIFdelbegin %DIFDELCMD < \big] %%%
\DIFdel{\dd{\bf r} \dd{\bf r}' }\DIFdelend \DIFaddbegin \right]\DIFadd{\,}\DIFaddend .
    \end{aligned}
\end{equation}
\DIFdelbegin \DIFdel{Interestingly, it }\DIFdelend \DIFaddbegin \DIFadd{We note the structure of the empirical connection in }\eqref{eq:empiricalbalance1} \DIFaddend is reminiscent of the connection between \DIFdelbegin \DIFdel{density correlations }\DIFdelend \DIFaddbegin \DIFadd{two and three body correlations at equilibrium as }\DIFaddend provided by the YBG hierarchy\DIFdelbegin \DIFdel{at equilibrium~\mbox{%DIFAUXCMD
\cite{Hansen2013} }%DIFAUXCMD
.
}\DIFdelend \DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\cite{Hansen2013} }%DIFAUXCMD
with the equilibrium pair correlation function replaced by correlation function averaged over the equilibrium and non-equilibrium steady states. Finally, we note that this connection can be further rewritten in a compact form that relates the deviations of two and three body correlations from their equilibrium values, 
}\begin{equation}
    \DIFadd{\label{eq:empiricalbalance2}
    \begin{aligned}
    }&\DIFadd{\rho^2 \int \int\ d}{\DIFadd{\bf r}} \DIFadd{d}{\DIFadd{\bf r}}\DIFadd{^\prime \left[g_3(}{\DIFadd{\bf r}}\DIFadd{,}{\DIFadd{\bf r}}\DIFadd{^\prime)-g_{3,\rm eq}(}{\DIFadd{\bf r}}\DIFadd{,}{\DIFadd{\bf r}}\DIFadd{^\prime)\right]\left[\nabla u(}{\DIFadd{\bf r}}\DIFadd{)\cdot \nabla u(}{\DIFadd{\bf r}}\DIFadd{^\prime)\right]}\\
    &\DIFadd{\quad =-\rho_0 \int d}{\DIFadd{\bf r}}\DIFadd{\frac{1}{2}\left[g(}{\DIFadd{\bf r}}\DIFadd{-g_{\rm eq}(}{\DIFadd{\bf r}}\DIFadd{)\right]\left[\nabla u(}{\DIFadd{\bf r}}\DIFadd{)^2-T\nabla^2 u(}{\DIFadd{\bf r}}\DIFadd{)\right]\,.
    \end{aligned}
}\end{equation}
\DIFaddend 
...
\begin{equation}\label{eq:balance_b}
	\begin{aligned}
		\DIFaddbegin \DIFadd{\gamma}\DIFaddend \dot w &= \DIFdelbegin \DIFdel{\frac{\rho_0}{\gamma} }\DIFdelend \DIFaddbegin \DIFadd{\rho_0 }\DIFaddend \int g({\bf r}) \big[(\nabla v({\bf r}))^2 - T \nabla^2 v({\bf r})\big] \dd{\bf r} ,
		\\
		&\quad + \DIFdelbegin \DIFdel{\frac{\rho_0^2}{\gamma} }\DIFdelend \DIFaddbegin \DIFadd{\rho_0^2 }\DIFaddend \iint g_3({\bf r}, {\bf r}') \big[\nabla v({\bf r})\big] \cdot \big[\nabla v({\bf r}')\big] \dd{\bf r} \dd{\bf r}' ,
	\end{aligned}
\end{equation}
...
\begin{equation}\DIFdelbegin %DIFDELCMD < \label{eq:balance_c}
%DIFDELCMD < 	%%%
\DIFdelend 
	\DIFaddbegin \DIFadd{\gamma}\DIFaddend \dot w = \DIFdelbegin \DIFdel{\frac{1}{\gamma}}\DIFdelend \sum_i \big[ \big\langle{\bf F}_i^2\big\rangle + T \big\langle\nabla_i\cdot{\bf F}_i\big\rangle \big] ,
\end{equation}
\DIFdelbegin \DIFdel{which differs from the relation }\DIFdelend \DIFaddbegin \DIFadd{formally analogue to the relation in}\DIFaddend ~\eqref{eq:approx} for driven tracers \DIFdelbegin \DIFdel{by }\DIFdelend \DIFaddbegin \DIFadd{up to }\DIFaddend an overall factor of $2$. \DIFdelbegin \DIFdel{A result analogue to~}%DIFDELCMD < \eqref{eq:balance_c} %%%
\DIFdel{was found previously for deterministic drive~\mbox{%DIFAUXCMD
\cite{Maes2010, Maes2015}}%DIFAUXCMD
. The main difference is that~}%DIFDELCMD < \eqref{eq:balance_c} %%%
\DIFdel{only features interaction forces ${\bf F}_i$ in the rhs, thus allowing one to evaluate the rate of work without any prior knowledge on the driving force. Besides, it is valid for both deterministic and active drives. Moreover, conducting the }\DIFdelend \DIFaddbegin \DIFadd{Conducting the }\DIFaddend same analysis of density correlations as for driven tracers, ${\cal I}$ exhibits again a scaling with ${\rm Pe}^2$, as reported in Fig.~\ref{fig:fig2_ac}. \DIFdelbegin \DIFdel{We }\DIFdelend \DIFaddbegin \DIFadd{Besides, we }\DIFaddend show that $\dot w$ and $\int{\cal I}({\bf r}){\rm d}{\bf r}$ are in good agreement when now introducing the factor $\rho_0/(2\gamma)$. \DIFdelbegin \DIFdel{This is consistent with substituting~}%DIFDELCMD < \eqref{eq:emp_b} %%%
\DIFdel{into~}%DIFDELCMD < \eqref{eq:balance_b}%%%
\DIFdel{, where $g_{3,a}+g_{3,b}$ is now replaced by $2g_3$, as expected. Hence, it demonstrates }\DIFdelend \DIFaddbegin \DIFadd{We note that this empirical connection with the modified factor of $\rho_0/(2\gamma)$ is still consistent with the non-equilibrium connection between two and three body correlations proposed in }\eqref{eq:empiricalbalance1}\DIFadd{, }\eqref{eq:empiricalbalance2}\DIFadd{. These results demonstrate }\DIFaddend that dissipation is also accessible from the nonequilibrium deviation of pair \DIFdelbegin \DIFdel{correlations }\DIFdelend \DIFaddbegin \DIFadd{correlation even }\DIFaddend in fully driven \DIFaddbegin \DIFadd{(or active) }\DIFaddend liquids.
...
\begin{equation}\label{eq:dyn_eq}
	\gamma\dot{\bf r}_i = - \nabla_i \sum_j v({\bf r}_i-{\bf r}_j) + {\boldsymbol\xi}_i ,
\end{equation}
where the statistics of the noise term ${\boldsymbol\xi}_i$ is the same as the one in~\eqref{eq:dyn}. The rate of work $\dot w$ defined in~\eqref{eq:work} is zero because of the absence of \DIFdelbegin \DIFdel{driving}\DIFdelend \DIFaddbegin \DIFadd{the driving force}\DIFaddend . In Sec.~\ref{sec:method}, to obtain a non-zero rate of energy flow through the system, we consider an explicit driving force ${\bf F}_{{\rm d},i}$ and we explore its effects on the \DIFdelbegin \DIFdel{transport and }\DIFdelend structural properties of the liquid. In \DIFdelbegin \DIFdel{practice, different types of driving can lead to same dissipation. In }\DIFdelend this section, using the framework of large deviation theory, we take an alternative approach where the dynamics is now conditioned by enforcing a required energy flow\DIFdelbegin \DIFdel{without any explicit driving}\DIFdelend . Thus, exploring how the system adapts to this requirement provides a new insight\DIFaddbegin \DIFadd{, distinct from the one in Sec.~\ref{sec:method}, }\DIFaddend into the relation between dissipation\DIFaddbegin \DIFadd{, structural properties }\DIFaddend and organization in driven systems\DIFdelbegin \DIFdel{, which is distinct from yet complements the approach in Sec.
~\ref{sec:method}.
}\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 


To this end, we focus on the subset of noise realizations that are effectively equivalent to dynamics with non-zero rate of work. Such dynamics are {\it atypical} since they correspond to realizations largely deviated from the most probable ones, thus opening the door to stabilizing structure and to promoting collective effects which are not {\it typically} observed. In particular, for this subset, the noise term in~\eqref{eq:dyn_eq} no longer has zero average, so that one can re-define it as \DIFdelbegin \DIFdel{${\boldsymbol \xi}_i \to {\boldsymbol \xi}_i + {\bf F}_{{\rm aux},i}$ }\DIFdelend \DIFaddbegin \DIFadd{${\boldsymbol \xi}_i \to {\boldsymbol \xi}_i + {\bf F}_i$ }\DIFaddend in terms of an {\it auxiliary force} force \DIFdelbegin \DIFdel{${\bf F}_{{\rm aux},i}$}\DIFdelend \DIFaddbegin \DIFadd{${\bf F}_i$}\DIFaddend ~\cite{Jack2010, Chetrite2013}. Hence, \DIFdelbegin \DIFdel{the dynamics given by~}%DIFDELCMD < \eqref{eq:dyn_eq} %%%
\DIFdel{with added force ${\bf F}_{{\rm aux},i}$ }\DIFdelend \DIFaddbegin \DIFadd{it }\DIFaddend provides an explicit realization \DIFdelbegin \DIFdel{which ensures }\DIFdelend \DIFaddbegin \DIFadd{of forces that will ensure }\DIFaddend a non-zero energy flow rate.
...
\end{equation}
In practice, computing $\cal G$ is a highly non-trivial procedure for many-body systems. The explicit solutions \DIFdelbegin \DIFdel{considered so far concern either exclusion processes~\mbox{%DIFAUXCMD
\cite{Popkov2010, Popkov2011, Limmer2018a} }%DIFAUXCMD
or particle-based diffusive systems restricted to small noise regimes~\mbox{%DIFAUXCMD
\cite{Lecomte2019, Proesmans2019} }%DIFAUXCMD
and }\DIFdelend \DIFaddbegin \DIFadd{obtained so far for diffusive particle-based dynamics are mostly restricted to }\DIFaddend non-interacting \DIFdelbegin \DIFdel{cases in some specific potentials~\mbox{%DIFAUXCMD
...
\begin{figure*}
	...
	\end{flushleft}
	\vskip-.6cm
	\DIFdelbeginFL \DIFdelFL{\raisebox{2.1cm}}%DIFDELCMD < {%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\raisebox{2.3cm}}{\DIFaddendFL \rotatebox{90}{\large $D_{\rm r}>D_{\rm r}^*$}}
	...
	\rule{5.81cm}{.2mm}
	\vskip-.05cm
	\DIFdelbeginFL \DIFdelFL{\raisebox{2.2cm}}%DIFDELCMD < {%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\raisebox{2.35cm}}{\DIFaddendFL \rotatebox{90}{\large $D_{\rm r}<D_{\rm r}^*$}}
	\includegraphics[width=.318\linewidth]{snap_k02D7.pdf}
	\DIFdelbeginFL \DIFdelFL{\raisebox{-.5cm}}%DIFDELCMD < {%%%
\DIFdelFL{\rule{.2mm}{6.3cm}}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\raisebox{-0.7cm}}{\DIFaddFL{\rule{.2mm}{6.5cm}}\DIFaddendFL }
	\includegraphics[width=.318\linewidth]{snap_k0D7.pdf}
	\includegraphics[width=.318\linewidth]{snap_km02D7.pdf}
	\begin{flushleft}
		\vskip\DIFdelbeginFL \DIFdelFL{-.6}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-.5}\DIFaddendFL cm
		{\large
			\hskip2.55cm
			$\kappa=-0.2$
			\hskip4.48cm
...
\subsection{Bias-induced collective motion}
\DIFdelbegin %DIFDELCMD < \label{sec:vicsek}
%DIFDELCMD < 
